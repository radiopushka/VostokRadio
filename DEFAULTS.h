...
float def_attack[]={ 0.070   ,0.0005  ,0.0008 ,0.0011  ,0.0015   ,0.0010};//multiband compression attack
float def_release[]={ 0.500  ,0.0600  ,0.0650 ,0.0500  ,0.0100   ,0.1000}; //multiband compression release
