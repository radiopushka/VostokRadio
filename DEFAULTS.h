...
float def_attack[]={ 0.340   ,0.000000001  ,0.00000004 ,0.00000011  ,0.000035   ,0.000000010};//multiband compression attack
...
float def_m_gain[]={1.3,1.1,1.2,1.3,1.4,2}; //make up gain
