...
float def_target[]={21000,20000,21000,21000,23000,23000}; //multiband compression target volume 
...
float knee[]={5000,9000,10000,10000,9000,2000};//knee
...
#define AGC_SPEED 0.00008 //response coefficient
