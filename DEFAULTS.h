...
float def_attack[]={ 200   ,150  ,  100  ,20  , 9  ,1.5};//multiband compression attack
float def_release[]={ 600 , 300  ,200 ,150 ,80   ,3}; //multiband compression release
float def_target[]={26000,12000,14000,16000,19000,27000}; //multiband compression target volume 
...
#define AGC_TARG 9000 //input AGC baseline target
#define AGC_LOOKAHEAD 1000
#define AGC_SPEED 0.0003 //response coefficient
