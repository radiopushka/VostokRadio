...
float def_attack[]={ 0.640   ,0.001  ,0.004 ,0.0071  ,0.00035   ,0.005};//multiband compression attack
float def_release[]={ 1.000 , 170  ,65.0 ,35.0  ,10.0   ,0.01000}; //multiband compression release
...
float post_amp[]={1,0.3,0.4,0.4,0.6,1}; // band compression post amplification
float effect[]={4,8,8.0,10.0,12.0,12.0};//ratio
float knee[]={80,15,15,15,15,3};//knee
