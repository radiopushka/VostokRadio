...
#define SIGMOIDAL_ATTACK  0.03
#define SIGMOIDAL_RELEASE 0.03
#define SIGMOIDAL_BUFFER 200
#define SIGMOIDAL_DRANGE 16383 //this should be near the start of the convergance to 1 or -1 of the tanh function relative to the limit
