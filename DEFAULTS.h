...
float def_release[]={ 600 , 600  ,450 ,350 ,250   ,0.8}; //multiband compression release
float def_target[]={36000,19000,19500,20000,20000,36000}; //multiband compression target volume 
