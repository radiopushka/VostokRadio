...
#define SIGMOIDAL_DRANGE 2191 //this should be near the start of the convergance to 1 or -1 of the tanh function relative to the limit
...
#define AGC_TARG 10000 //input AGC baseline target
