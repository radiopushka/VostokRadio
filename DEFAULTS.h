...
float def_attack[]={ 20   ,5  ,  3  ,1.5  , 1  ,0.6};//multiband compression attack
float def_release[]={ 600 , 300  ,250 ,250 ,250   ,0.8}; //multiband compression release
float def_target[]={26000,19000,19500,20000,20000,36000}; //multiband compression target volume 
