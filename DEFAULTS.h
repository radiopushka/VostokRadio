...
float def_attack[]={ 100   ,0.1  ,  0.1  ,0.1  , 0.5   ,0.0001};//multiband compression attack
float def_release[]={ 600 , 77  ,65 ,35  ,10   ,0.005000}; //multiband compression release
...
float post_amp[]={2,1,1,0.5,0.5,8}; // band compression post amplification
float effect[]={4,12,30.0,30.0,30.0,22.0};//ratio
float knee[]={5000,10000,9000,8000,8000,100};//knee
