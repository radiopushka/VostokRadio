...
float def_release[]={ 0.500  ,0.0600  ,0.0650 ,0.0100  ,0.0100   ,0.0010}; //multiband compression release
float def_target[]={5000,4000,4000,5000,5000,9000}; //multiband compression target volume 
