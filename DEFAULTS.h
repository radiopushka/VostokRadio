...
float def_attack[]={ 0.070   ,0.005  ,0.008 ,0.011  ,0.015   ,0.00000001};//multiband compression attack
float def_release[]={ 0.500  ,0.600  ,0.350 ,0.100  ,0.100   ,0.00010}; //multiband compression release
