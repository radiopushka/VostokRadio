...
float def_release[]={ 1.000  ,17.0  ,6.50 ,3.50  ,1.00   ,0.01000}; //multiband compression release
...
float post_amp[]={1,0.3,0.4,0.4,0.4,1}; // band compression post amplification
float effect[]={4,8,8.0,10.0,12.0,12.0};//ratio
float knee[]={80,8,8,8,8,3};//knee
