...
float def_attack[]={ 34   ,0.0000001  ,  0.0000004    ,0.0000071  , 0.0000035   ,0.0000000005};//multiband compression attack
float def_release[]={ 100 , 77  ,65 ,35  ,200   ,1.000}; //multiband compression release
