...
float def_attack[]={ 20   ,5  ,  3  ,1  , 1  ,0.2};//multiband compression attack
float def_release[]={ 600 , 300  ,100 ,50 ,50   ,1}; //multiband compression release
float def_target[]={26000,20000,20000,20000,20000,43000}; //multiband compression target volume 
float def_m_gain[]={1.3,1.3,1.2,1.3,1.5,1}; //make up gain
float pre_amp[]={4,1,1,1,1,80}; //multiband compressor pre compression gain
...
float knee[]={20000,15000,8000,4000,2000,1000};//knee
