...
float def_attack[]={0.000008      ,0.00001     ,0.0001     ,0.0002     ,0.0004};//multiband compression attack
float def_release[]={0.0000001  ,0.000000001  ,0.000003   ,0.000003   ,0.00005}; //multiband compression release
float def_target[]={14000,12000,14000,17000,20000}; //multiband compression target volume 
