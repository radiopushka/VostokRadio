...
float def_attack[]={ 40   ,30  ,  25  ,20  , 9  ,1};//multiband compression attack
...
float post_amp[]={1,1,1,1,1,0.5}; // band compression post amplification
float effect[]={6,6,6.0,7.0,8.0,9.0};//ratio
float knee[]={10000,10000,10000,10000,10000,5000};//knee
...
#define SIGMOIDAL_DRANGE 3191 //this should be near the start of the convergance to 1 or -1 of the tanh function relative to the limit
...
#define AGC_SPEED 0.00012 //response coefficient
