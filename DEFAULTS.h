...
float def_release[]={ 600 , 300  ,250 ,250 ,150   ,0.8}; //multiband compression release
float def_target[]={26000,19000,19500,20000,20000,47000}; //multiband compression target volume 
