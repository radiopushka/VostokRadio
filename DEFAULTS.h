...
float def_target[]={20000,16000,13000,13000,16000,30000}; //multiband compression target volume 
float def_m_gain[]={1.05,1.01,1.01,1.05,1.2,2}; //make up gain
float pre_amp[]={3,1,1,1,1,250}; //multiband compressor pre compression gain
