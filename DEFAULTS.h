...
float def_attack[]={ 0.070   ,0.0001  ,0.0002 ,0.00011  ,0.00015   ,0.00000010};//multiband compression attack
float def_release[]={ 0.500  ,0.800  ,0.850 ,0.800  ,0.400   ,0.00001000}; //multiband compression release
