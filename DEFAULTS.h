...
float def_attack[]={ 0.070   ,0.00001  ,0.00002 ,0.000011  ,0.000015   ,0.000000010};//multiband compression attack
float def_release[]={ 0.500  ,0.800  ,0.850 ,0.800  ,0.400   ,0.000001000}; //multiband compression release
