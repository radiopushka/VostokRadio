...
float def_attack[]={0.0000001,0.00002,0.0003,0.0002,0.0004};
float def_release[]={0.000000000001,0.0000000001,0.0000000001,0.0000000001,0.0001};
float def_target[]={11000,11000,10000,10000,14000};
